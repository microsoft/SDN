...
if ($psCmdlet.ParameterSetName -ne "NoParameters") {
	...
	try{
		...
		Write-Host “”
		Write-Host "Network Controller service deployed." -foregroundcolor "Yellow"
        ...
        Write-Host “”
		Write-Host "Logical Network creation finished." -foregroundcolor "Yellow"      
		...
		Write-Host “”
		Write-Host "Software Load Balancing is deployed." -foregroundcolor "Yellow"
		...
		if( $node.DeployGW -eq $true )
		{
			...
			Write-Host “”
			Write-Host "RAS Gateway is deployed." -foregroundcolor "Yellow"
        }		
		
		Write-Host “”
		Write-Host "Congratulations! You have successfully deployed SDN！" -foregroundcolor "GREEN"
