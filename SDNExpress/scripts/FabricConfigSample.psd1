@{
    ...
    @(
        @{ 
            ...
            InstallSrcDir="\\$env:Computername\Deployment\SDNExpress"

            #VM Creation variables
                        
            VHDName="10586.9.amd64fre.th2_release.151110-1756_server_ServerDataCenter_en-us_vl.vhdx"    # Name of the VHDX to use for VM creation. must exist in the images path under InstallSrcDir
            ...
            DomainJoinPassword = 'SDN!Threshold10'                              #Example: "V3ryC0mplex4dminP4ssword"
            ...
            NetworkControllerRestName = "ncrest.$env:USERDNSDOMAIN"    #Example (after evaluation of $env:USERDNADOMAIN): myname.contoso.com
            NetworkControllerRestIP = "10.50.34.4"                         #Example: 10.20.30.40
            ...
            NCClusterPassword = 'SDN!Threshold10'                               #Example: MySuperS3cretP4ssword
            ...
            HostPassword = 'SDN!Threshold10'                                    #Example: MySuperS3cretP4ssword
                ...
                @{
                    ...
                    Subnets = @(
                        @{
                            ...
                            DNS = @("10.50.34.3")                          #Example: @("10.0.0.7", "10.0.0.8", "10.0.0.9")
                            Gateways = @("10.60.34.1")                     #Example: @("10.0.10.1")
                            PoolStart = "10.60.34.50"                       #Example: "10.0.10.50"
                            PoolEnd = "10.60.34.100"                         #Example: "10.0.10.150"
                       }
                    )
                },    
                @{
                    ...
                    Subnets = @(
                        @{
                            ...
                            PoolStart = "10.80.0.50"                       #Example: "10.0.20.5"
                            PoolEnd = "10.80.0.200"                         #Example: "10.0.20.100"
                            IsPublic = $true
                            IsVIP = $true
                        }  
                    )
                ...
                @{
                    ...
                    Subnets = @(
                        @{  ## Gre GW's VIP Subnet
                            ...
                            PoolStart = "10.90.0.50"                       #Example: "10.0.30.5"
                            PoolEnd = "10.90.0.200"                         #Example: "10.0.30.100"
                        }
                    )
                },
                @{
                    ...
                    Subnets = @(
                        @{
                            ...
                            PoolStart = "10.40.0.50"                       #Example: "10.0.40.5"
                            PoolEnd = "10.40.0.200"                         #Example: "10.0.40.100"
                        }  
                    )
                },    
                @{
                    ...
                    Subnets = @(
                        @{
                            ...
                            PoolStart = "10.50.34.50"                       #Example: "10.0.0.5"
                            PoolEnd = "10.50.34.200"                         #Example: "10.0.0.100"
                            IsVIP = $true                             
                        }  
                    )
                }
            ...
            GreBgpPeerRouterASN = '1'                             #Example: "0.1"
            GreBgpRouterASN = '3'                                 #Example: "0.2"
            ...
            GatewayPublicIPAddress = "10.80.0.60"                          #Example: 10.0.20.6
        ...
        @{ 
            ...
            VMs=@(
              @{ 
                ...
                NICs=@(
                    @{
                        Name="Management"
                        IPAddress="10.50.34.31"                           #Example: "10.0.0.10"
                        ...
                        MacAddress="001DC8000001"                         #Example: "001DC8000001"
            ...
            VMs=@(
              @{ 
                ...
                NICs=@(
                    @{
                        Name="Management"
                        IPAddress="10.50.34.32"                           #Example: "10.0.0.12"
                        LogicalNetwork = "Management"
              ...
              @{ 
                ...
                NICs=@(
                    @{
                        Name="Management"
                        IPAddress="10.50.34.21"                           #Example: "10.0.0.11"
                        LogicalNetwork = "Management"
            ...
            VMs=@(
              @{ 
                ...
                NICs=@(
                    @{
                        Name="Management"
                        IPAddress="10.50.34.33"                           #Example: "10.0.0.14"
                        LogicalNetwork = "Management"
              ...
              @{ 
                ...
                NICs=@(
                    @{
                        Name="Management"
                        IPAddress="10.50.34.22"                           #Example: "10.0.0.13"
                        LogicalNetwork = "Management"
         ...
         @{ 
            ...
            InternalNicMac = "00-20-11-11-11-01"
            ExternalNicMac = "00-20-11-11-11-02"
            ExternalIPAddress = "10.40.0.55"                             #Example: "10.0.40.5"
         },
         @{ 
            ...
            InternalNicMac = "00-20-11-11-11-03"
            ExternalNicMac = "00-20-11-11-11-04"                
            ExternalIPAddress = "10.40.0.56"                             #Example: "10.0.40.6"
         }
     );
}