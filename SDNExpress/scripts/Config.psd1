@{
    ...
    @(
        @{ 
            ...
            NetworkControllerRestName = "<<Replace>>.$env:USERDNSDOMAIN"    #Example (after evaluation of $env:USERDNADOMAIN): myname.contoso.com
        ...
        @{ 
         ...
         @{ 
            ...
            MuxVirtualServerResourceId = 'd2b75161-ec7d-4141-8653-39ab194a2291'
            MuxResourceId = '86c0a59c-4ffe-4b12-847c-641291fb465c'
         },
         @{ 
            ...
            #These resource ids are one per mux
            MuxVirtualServerResourceId = 'a3f1b6a0-d0e7-46a0-85a2-354f44a8cfce'
            MuxResourceId = '97bb1718-3bf4-4264-bd6a-4438a932af0a'
         },         
         @{ 
