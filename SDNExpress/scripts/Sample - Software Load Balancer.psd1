@{
   ...
   NCs = @(
    ...
    Gateways = @()
       ...
       # @{ComputerName='Contoso-GW01'; ManagementIP='10.127.132.174'; MACAddress = '001DD8220003'},
      #  @{ComputerName='Contoso-GW02'; ManagementIP='10.127.132.175'; MACAddress = '001DD8220004'}
    #)
